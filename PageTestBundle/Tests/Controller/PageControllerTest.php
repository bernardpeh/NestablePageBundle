...
class PageControllerTest extends WebTestCase
{
    ...
    {
        $client = static::createClient();
        $csrfToken = $client->getContainer()->get('security.csrf.token_manager')->refreshToken('bpeh_page_reorder');
    ...
    public function testCreateDeleteTestPage()
    {
        ...
        // go to new pagemeta page
        $crawler = $client->request('GET', '/pagemeta_test/new');
